...
#
# This file has been copied from CERN Open Data Portal
# http://opendata.cern.ch/record/12350
# and very slightly modified to dump plots to a plots subdirectory
...
def main(variable):
    ...
    # Save
    c.SaveAs("plots/{}.pdf".format(variable))
    c.SaveAs("plots/{}.png".format(variable))
